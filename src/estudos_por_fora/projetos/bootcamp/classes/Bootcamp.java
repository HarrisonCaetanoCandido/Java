...
public class Bootcamp {
    ...
    private final LocalDate dataFinal = dataInicial.plusDays(45); // tem fim 45 dias dps de instanciar
    private Set<Dev> devsInscritos = new HashSet<>(); // praticamente polimorfismo
    private Set<Conteudo> conteudos = new LinkedHashSet<>(); // praticamente polimorfismo
